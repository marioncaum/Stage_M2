...
\begin{ganttchart}[inline]{1}{14}
    ...
    \ganttbar{$a_{2p}$}{5}{6} 
    \ganttbar{$a_n$}{7}{8}
    \ganttbar{$a_{p+1}$}{9}{10} 
    \ganttbar{$\dots$}{11}{12}
    \ganttbar{$a_{2p}$}{13}{14}
\end{ganttchart}
\begin{exemple}
$n=3$ et $x=4$. On note les agents $a$, $b$ et $c$.\\
\begin{ganttchart}[inline]{1}{12}
...
\begin{ganttchart}[inline]{1}{14}
    ...
    \ganttbar{$\dots$}{11}{12}
    \ganttbar{$a_1$}{13}{14} \\
    \ganttbar{$a_{2p+1}$}{1}{2}
    \ganttbar{$\dots$}{3}{4} 
    \ganttbar{$a_{4p}$}{5}{6} 
    \ganttbar{$a_n$}{7}{8}
    \ganttbar{$a_{2p+1}$}{9}{10} 
    \ganttbar{$\dots$}{11}{12}
    \ganttbar{$a_{4p}$}{13}{14}
\end{ganttchart}\\
...
\begin{ganttchart}[inline]{1}{14}
    \ganttbar{$a_1$}{1}{2}
    \ganttbar{$\dots$}{3}{4} 
    \ganttbar{$a_{2p+1}$}{5}{6} 
    \ganttbar{$a_n$}{7}{8}
    \ganttbar{$a_{2p+1}$}{9}{10} 
    \ganttbar{$\dots$}{11}{12}
    \ganttbar{$a_1$}{13}{14} \\
    \ganttbar{$a_{2p+2}$}{1}{2}
    \ganttbar{$\dots$}{3}{4} 
    \ganttbar{$a_{4p+2}$}{5}{6} 
    \ganttbar{$a_n$}{7}{8}
    \ganttbar{$a_{2p+2}$}{9}{10} 
    \ganttbar{$\dots$}{11}{12}
    \ganttbar{$a_{4p+2}$}{13}{14}
\end{ganttchart}\\
